...
namespace InputIcons
{
    ...
    public class InputIconSetKeyboardSO : InputIconSetBasicSO
    {
        ...
        {
            mouse = new InputSpriteData("Mouse Simple", mouse.sprite, "Delta");
            mouse_left = new InputSpriteData("Mouse Left", mouse_left.sprite, "LeftButton");
            mouse_right = new InputSpriteData("Mouse Right", mouse_right.sprite, "RightButton");
            mouse_middle = new InputSpriteData("Mouse Middle", mouse_middle.sprite, "MiddleButton");
