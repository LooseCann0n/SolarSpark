...
namespace InputIcons
{
    public class InputIconsUtility : MonoBehaviour
    {
        ...
        public class InputStyleData
        {
            ...
            public InputStyleData(InputBinding b, string bName, bool isComp, bool isPartOfComp, string tmproText, string style, string humanReadableStr)
            {
                binding = b;
        ...
        public static InputStyleData GetStyleOpeningTag(InputAction action, InputBinding binding, string deviceDisplayName, string controlSchemeName)
        {
            ...
            InputStyleData isd = new InputStyleData(binding, bindingName, binding.isComposite, binding.isPartOfComposite, tmproReference, styleOpeningTag, humanReadableString);
