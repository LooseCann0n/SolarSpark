...
public partial class @II_InputActions_Player : IInputActionCollection2, IDisposable
{
    ...
    public struct PlatformerControlsActions
    {
        ...
        public void SetCallbacks(IPlatformerControlsActions instance)
        {
            ...
            {
                @Cancel.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnCancel;
                @Cancel.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnCancel;
                @Cancel.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnCancel;
                @Submit.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSubmit;
                @Submit.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSubmit;
                @Submit.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSubmit;
                ...
                @Look.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnLook;
                @Look.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnLook;
                @Look.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnLook;
                ...
                @Attack.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnAttack;
                @Attack.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnAttack;
                @Attack.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnAttack;
                @SwitchWeapon.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSwitchWeapon;
                @SwitchWeapon.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSwitchWeapon;
                @SwitchWeapon.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnSwitchWeapon;
                @Pause.started -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_PlatformerControlsActionsCallbackInterface.OnPause;
            }
    ...
    private IHelicopterControlsActions m_HelicopterControlsActionsCallbackInterface;
    ...
    public struct HelicopterControlsActions
    {
        ...
        {
            if (m_Wrapper.m_HelicopterControlsActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnMove;
                @Rotate.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnRotate;
                @Rotate.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnRotate;
                @Rotate.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnRotate;
                @ThrowBomb.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnThrowBomb;
                @ThrowBomb.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnThrowBomb;
                @ThrowBomb.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnThrowBomb;
                @NextWeapon.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnNextWeapon;
                @NextWeapon.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnNextWeapon;
                @NextWeapon.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnNextWeapon;
                @PreviousWeapon.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPreviousWeapon;
                @PreviousWeapon.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPreviousWeapon;
                @PreviousWeapon.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPreviousWeapon;
                @Pause.started -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_HelicopterControlsActionsCallbackInterface.OnPause;
            }
            m_Wrapper.m_HelicopterControlsActionsCallbackInterface = instance;
            if (instance != null)
            {
                @Move.started += instance.OnMove;
                @Move.performed += instance.OnMove;
